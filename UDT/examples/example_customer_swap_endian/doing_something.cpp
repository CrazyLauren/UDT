...
extern int msg_test_handler(CCustomer* WHO, void* aWHAT, void* YOU_DATA)
{
	...
	/*! 2) Convention pointer to message data to pointer to #swap_byte_order_data */
...
extern void send_messages()
{
	...
	for (unsigned i=0;i<255;++i)
	{
		...
		///4) Filing the header of message #E_MSG_SWAP_BYTE_TEST
		required_header_t const _header(
				msg_head_t(E_MSG_SWAP_BYTE_TEST,
						sizeof(swap_byte_order_msg_t)));

		///5) Send the message number #E_MSG_SWAP_BYTE_TEST of user protocol #PROTOCOL_NAME
...
<<<<<<< HEAD:UDT/examples_old/example_customer_swap_endian/doing_something.cpp

>>>>>>> 8543561... see ChangeLog.txt:UDT/examples_old/example_customer_swap_endian/doing_something.cpp
=======
}
>>>>>>> 38a6ae7... see changelog:UDT/examples/example_customer_swap_endian/doing_something.cpp
