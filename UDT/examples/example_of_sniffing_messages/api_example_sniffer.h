 ...
 */
#ifndef EXAMPLE_SNIFFER_API_H_
#define EXAMPLE_SNIFFER_API_H_

namespace example_of_sniffing_messages
{
#define INDITIFICATION_NAME "uex_snif@guex" ///<Identification program name which will see another program
 ...
 *\return 0
 */
extern int sniffer_handler(NUDT::CCustomer* WHO, void* WHAT, void* YOU_DATA);
