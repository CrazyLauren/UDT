 ...
 */
#ifndef EXAMPLE_SENDTO_API_H_
#define EXAMPLE_SENDTO_API_H_

namespace example_of_sendto_msg
{
#define INDITIFICATION_NAME "uex_sendto@guex" ///<Identification program name which will see another program
