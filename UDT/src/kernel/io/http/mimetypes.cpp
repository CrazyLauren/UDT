...
namespace NUDT
{
static const NSHARE::CText  g_mimetypes  [] =
{
    "323",            "text/h323",
...
NSHARE::CText CHttpResponse::sMGetMimetype (NSHARE::CText const& filename)
{
    if (!filename.empty())
    {
    	NSHARE::CText::size_type const _pos=filename.find_last_of('.');
