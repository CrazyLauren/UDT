...
#include <share/Socket/shared_identify.h>

namespace NSHARE
{
class SHARE_EXPORT CSharedMemoryBase:public ISocket,public NSHARE::CEvents<NSHARE::CText>,NSHARE::CDenyCopying
{
public:
	...
	virtual const CSocket& MGetSocket(void) const;
