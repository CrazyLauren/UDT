...
set (CMAKE_C_COMPILER ${QNX_HOST}/usr/bin/qcc${HOST_EXECUTABLE_SUFFIX} CACHE PATH  "" FORCE)

if(DEFINED ADITIONAL_FLAGS)
	set (CMAKE_C_FLAGS_INIT "-V${QNX_COMPILER_VERSION},gcc_nto${CMAKE_SYSTEM_PROCESSOR} ${ADITIONAL_FLAGS}" CACHE INTERNAL "" FORCE)
else()
...
set (CMAKE_CXX_COMPILER ${QNX_HOST}/usr/bin/qcc${HOST_EXECUTABLE_SUFFIX} CACHE PATH "" FORCE)
